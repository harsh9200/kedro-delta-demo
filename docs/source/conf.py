...
# kedro_delta_demo documentation build
...
from kedro_delta_demo import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_delta_demo"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_delta_demodoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_delta_demo.tex",
        "kedro_delta_demo Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_delta_demo",
        "Project kedro_delta_demo codebase.",
        "Data-Science",
    )
]
